        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="p-8 bg-gray-800 rounded-3xl shadow-lg text-white max-w-sm mx-4">
            ...
            <div className="flex justify-end gap-x-4">
              <button onClick={handleDeleteCancel} className="px-6 py-2 font-medium rounded-xl bg-white/10 hover:bg-white/20 transition-colors">
                Cancel
              </button>
              <button onClick={handleDeleteConfirmed} className="px-6 py-2 font-bold text-white bg-red-500 hover:bg-red-600 rounded-xl transition-colors">
                Delete
              </button>
            </div>
          </div>
